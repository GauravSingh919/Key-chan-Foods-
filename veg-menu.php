...
$veg_query = mysqli_query($spizy_db_con,'SELECT * FROM menu_data WHERE category = "Veg" ORDER BY RAND()');
?>
<!DOCTYPE HTML>
<html lang="en">
<head>
        ...
        <div id="wrapper">
            <div class="content">
                ...
                <section class="parallax-section header-section">
                    <div class="bg bg-parallax" style="background-image:url(images/bg/4.jpg)" data-top-bottom="transform: translateY(300px);" data-bottom-top="transform: translateY(-300px);"></div>
                ...
                <section>
                    ...
                    <div class="menu-bg rbd" style="background-image:url(images/menu/3.png)" data-top-bottom="transform: translateX(-200px);" data-bottom-top="transform: translateX(200px);">
                    </div>
                    <div class="container">
                        <div class="separator color-separator"></div>
                        <div class="menu-holder pb-4">
                            <div class="row">
                            <?php
                                if($veg_query){
