...
$dessert_query = mysqli_query($spizy_db_con,'SELECT * FROM menu_data WHERE category = "Dessert" ORDER BY RAND()');
?>
<!DOCTYPE HTML>
<html lang="en">
        ...
        <div id="wrapper">
            <div class="content">
                ...
                <section class="parallax-section">
                    <div class="bg bg-parallax" style="background-image:url(images/bg/11.jpg)" data-top-bottom="transform: translateY(300px);" data-bottom-top="transform: translateY(-300px);"></div>
