...
$drink_query = mysqli_query($spizy_db_con,'SELECT * FROM menu_data WHERE category = "Drinks" ORDER BY RAND()');
?>
    <!DOCTYPE HTML>
    <html lang="en">
    ...
    <body>
        <div class="modal fade" id="get_plate_details_ajax_modal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <div class="modal fade" id="user_login_register_modal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content custom-modal-border">
                    <div class="modal-header custom_modal_text_head">
                    ...
                    <div class="modal-body get_plate_details_ajax_response">
                        <ul class="nav justify-content-center" id="pills-tab" role="tablist">
                            <li class="nav-item" style="margin:0 20px" ; role="presentation">
                                <a class="nav-link active btn custom-button-sm" id="pills-login-tab" data-toggle="pill" href="#pills-login" role="tab" aria-controls="pills-login" aria-selected="true">Login</a>
                            </li>
                            <li class="nav-item" style="margin:0 20px" ; role="presentation">
                                <a class="nav-link btn custom-button-sm" id="pills-register-tab" data-toggle="pill" href="#pills-register" role="tab" aria-controls="pills-register" aria-selected="false">Register</a>
                            </li>
                        </ul>
                        <div class="tab-content pt-0" style="display:block !important" ; id="pills-tabContent">
                            <div class="tab-pane fade register_tab" id="pills-register" role="tabpanel" aria-labelledby="pills-register-tab">
                                <div class="login_register-form-holder">
                                    <div class="mt-4" id="login_register-form">
                                        ...
                                        <button type="button" id="register_button" class="btn custom-button-sm">Submit</button>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade show active login_tab" id="pills-login" role="tabpanel" aria-labelledby="pills-login-tab">
                                <div class="login_register-form-holder">
                                    <div class="mt-4" id="login_register-form">
            ...
            <div id="wrapper">
                <div class="content">
                    ...
                    <section class="parallax-section">
                        <div class="bg bg-parallax" style="background-image:url(http://lambert.kwst.net/site/images/bg/20.jpg)" data-top-bottom="transform: translateY(300px);" data-bottom-top="transform: translateY(-300px);"></div>
                    ...
                    <section>
                        ...
                        <div class="menu-bg lbd" style="background-image:url(http://lambert.kwst.net/site/images/menu/3.png)" data-top-bottom="transform: translateX(200px);" data-bottom-top="transform: translateX(-200px);">
                        </div>
                        <div class="container">
                                        ...
                                        echo '<div class="col-md-6 mb-2">
                                                <div class="menu-item menu-item-border">
                                                    <div class="menu-item-details">
                                                        ...
                                                        <button class="add-to-cart-button-sm" onclick="add_to_cart('.$drink_query_array['id'].')"><i class="fas fa-plus-square"></i></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>';
